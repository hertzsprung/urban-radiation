...
set term postscript eps enhanced color size 240,6
...
set format x "%m-%d"
set xtics 86400
set xrange ["2010-10-01 00:00:00":"2010-12-31 00:00:00"]
plot 'model_obs.dat' using 1:5 title "TOA", \
     ...
     'model_obs.dat' using 1:($6) axes x1y2 title "optical depth" lt -1
